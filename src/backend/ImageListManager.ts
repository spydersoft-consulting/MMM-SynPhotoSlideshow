...
class ImageListManager {
	...
	private readonly trackerFilePath = 'modules/MMM-SynPhotoSlideshow/filesShownTracker.txt';
	 ...
	 */
	private sortImageList(imageList: PhotoItem[], sortBy: string, sortDescending: boolean): PhotoItem[] {
